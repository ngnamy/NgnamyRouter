...
<html lang="fr">
    ...
    <body>
        <header>
            <nav class="main-nav">
                <?= Helpers::link($router->url('accueil'), ["class"=> 'link'], 'Accueil', 'home') ?>
                <?= Helpers::link($router->url('about'), ["class"=> 'link'], 'A propos', 'square') ?>
                <?= Helpers::link($router->url('contact'), ["class"=> 'link'], 'Contact', 'phone') ?>
            </nav>
        </header>
